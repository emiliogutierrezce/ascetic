...
import WeeklySummary from '../components/WeeklySummary'; // <-- 1. IMPORTAR
...
export default async function DashboardPage() {
  ...
  // b) Calcular datos para Pendientes
  ...
  // --- Búsquedas para los paneles del día (sin cambios) ---
  ...
  return (
    <div>
      ...
      {/* 2. AÑADIR EL COMPONENTE DE RESUMEN */}
      <WeeklySummary
